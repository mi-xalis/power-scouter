...
if "user_id" not in st.session_state:
    ...
    st.session_state.session_selector = 0   # initialize session selector
...
<style>
    ...
    section[data-testid="stSidebar"] {
        ...
        padding-top: 0 !important;          /* Removes default top padding */
    }

    /* Optional: remove any extra top margin from the first element */
    ...
    section[data-testid="stSidebar"] .stButton button {
        background-color: #F57C00 !important;  /* Goku orange */
        border: none;
    }

    /* Optional: make the image stretch full width without extra spacing */
    section[data-testid="stSidebar"] img {
        margin-bottom: 1rem;   /* adds a little space below the image */
    }
</style>
""", unsafe_allow_html=True)
    
    #st.header("It's Over 9000!")
    st.image("assets/gk_s_top.jpg", width='stretch')#width='stretch')
                ...
                if login_button:
                    if username and password:
                        ...
                        if user_id:
                            ...
                            st.session_state.session_selector = 0  # reset to create new
    ...
    if st.session_state.current_session_id == 0:
        with st.form("new_session"):
            ...
            if create_session_btn and session_name:
                ...
                st.rerun()
        st.stop()  # Stop here so the logging UI doesn't appear
